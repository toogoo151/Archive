        ...
        if (
            ...
            axios
                ...
                .then((res) => {
                    ...
                    console.log(res.data.sportEdit);
                })
                .catch((err) => {
                    console.log(err);
                });
        ...
        <div>
            ...
            {getEditBtn == 2 ? (
                ...
                <MUIDatatable
                    ...
                    setRowsSelected={setRowsSelected}
                    isHideDelete={false}
                    isHideEdit={true} // edit button нээж өгсөн
                />
            )}
                ...
                <>
                    {props.clickedRowData.age < 41 ? (
                        <SportNew
                            ...
                            refreshSportApprove={props.refreshSportApprove}
