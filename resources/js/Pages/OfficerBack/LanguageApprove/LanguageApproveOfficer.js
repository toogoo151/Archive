...
import LanguageApproveOfficerEdit from "./LanguageApproveOfficerEdit";
import Swal from "sweetalert2";
import { AppContext } from "../../../Context/MyContext";
const LanguageApproveOfficer = () => {
    ...
    return (
        <div>
            ...
            <MUIDatatable
                ...
                btnEdit={btnEdit}
                modelType={showModal}
                editdataTargetID={"#languageApproveOfficerEdit"}
                btnDelete={btnDelete}
            ...
            />
            {/* {state.getMissionRowID != "" && state.getEeljRowID != "" && (
                <RotNew refreshLanguage={refreshLanguage} />
            )} */}

            <LanguageApproveOfficerEdit
                setRowsSelected={setRowsSelected}
