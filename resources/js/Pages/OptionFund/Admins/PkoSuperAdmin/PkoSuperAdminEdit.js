...
const PkoSuperAdminEdit = (props) => {
    ...
    return (
        <>
            <div className="modal" id="superUserEdit">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <p>
                                ...
                                шаардлагатай. Мөн 65КБ-с ихгүй байна.
                            </p>
                        </div>
...
export default PkoSuperAdminEdit;
