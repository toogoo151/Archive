...
import ChildSportOther from "./ChildSportOther";
...
const SportOther = () => {
    ...
    const columns = [
        {
            ...
            label: "Төрийн цэргийн байгууллага",
            options: {
                filter: true,
                sort: false,
                display:
    ...
    return (
        <div>
            ...
            <br />
            {clickedRowData != "" && (
                <ChildSportOther clickedRowData={clickedRowData} />
            )}
        </div>
    );
};

export default SportOther;
