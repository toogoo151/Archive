...
const OffProcess = () => {
    ...
    const [getErHeltesmend, setErHeltesmend] = useState(0);
    const [getHealth, setHealth] = useState(0);
    const [getsport, setsport] = useState(0);
    const [getFlight, setFlight] = useState(0);
    const [getTomilogdson, setTomilogdson] = useState(0);
    const [checkTomilogdson, setTomilgoo] = useState(0);
    const [checkPdf, setPdf] = useState("");

    const [getDesc, setDesc] = useState([]);
    const [getLastDescription, setLastDescription] = useState([]);
    const [getHeltesDes, setgetHeltesDes] = useState([]);
    ...
    const changeMission = (e) => {
        setMissionID(e.target.value);
        axios
            .post("/get/eelj/officer/missionID", {
                _missionID: e.target.value,
            })
            .then((res) => {
                setEelj(res.data);
            ...
            axios
                ...
                .then((res) => {
                    if (res.data == 0) {
                        ...
                        setErHeltesmend(res.data[0].eruulMendHeltesApprove);
                        setHealth(res.data[0].healthApprove);
                        setsport(res.data[0].sportScore);
                        setFlight(res.data[0].isFlight);
                        setTomilogdson(res.data[0].isTomilogdson);
                        setPdf(res.data[0].healthPdf);
                        ...
                        // setgetHeltesDes(res.data[0].heltesDescription);
                        if (getDesc.length === 0) {
                            setDesc([
                        ...
                        if (getHeltesDes.length === -1) {
                            setgetHeltesDes([
                                /* initialize getHeltesDes with some values */
                            ]);
                        }
    ...
    return (
      ...
      /> */}
                                ...
                                <VerticalTimelineElement
                                    ...
                                    icon={
                                        getHealth == 1 && getsport == 0 ? (
                                            <img src={Imgicon} alt="Imgicon" />
                                        ) : getHealth == 0 && getsport == 0 ? (
                                            <img src={None} alt="None" />
                                        ) : (
                                            <img
                                                src={Righticon}
                                ...
                                {/* <VerticalTimelineElement
                                    ...
                                    icon={
                                        checkTomilogdson == 1 && getTomilogdson == 1  && getFlight == 0 ? (
                                            <img src={Imgicon} alt="Imgicon" />
                                        ) : checkTomilogdson == 1 && getTomilogdson === 1 && getFlight == 1 ? (
                                            <img
                                                src={Righticon}
                                                alt="Righticon"
                                            />
                                        ) : checkTomilogdson == 1 && getTomilogdson  === 1 && getFlight == 2 ? (
                                            <img
                                                src={Wrongicon}
                                                alt="Wrongicon"
                                            />
                            ...
                            icon={<img src={Imgicon} alt="Imgicon" />}
                        >
                            <h3 className="vertical-timeline-element-title">
                                Буух/эх орондоо ирэх
                            </h3>
                        </VerticalTimelineElement>
                        <VerticalTimelineElement
                            className="vertical-timeline-element--education"
