...
.topnav> a li {
    ...
    width: calc(4.0 * var(--menu-item-size));
...
<body>
    <div class="topnav">
        <a href="{{url("/about")}}" style="color: white"> <li class="active"><i class="fa fa-file" aria-hidden="true" style="color: white">&nbsp;</i>Бидний тухай</li></a>
