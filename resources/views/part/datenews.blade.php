@php
  // use Carbon\Carbon;
@endphp
<div class="titles">Хоногийн мэдээ</div>
<div class="last_news">
  <ul>
    @foreach ($DateNews as $DateNew)
      ...
      <div class="l_item" >
        <div class="l_item_img">
          ...
          @endif
          <a href="{{url("/datenews/onePost")}}/{{$DateNew->id}}"> </a>
        </div>
        <div class="l_title">
          <a href="#">{{$DateNew->title}}</a>
        </div>
        <div class="l_readmore"> <a href="{{url("/datenews/onePost")}}/{{$DateNew->id}}">Дэлгэрэнгүй</a> </div>
