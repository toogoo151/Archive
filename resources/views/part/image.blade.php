...
<img class="wave" src="images/wave.png">
  ...
  <div class="topnav">
        ...
        <a href="{{url("/image")}}" style="color: white"> <li class="active"> <i class="fa fa-picture-o" aria-hidden="true" style="color: white">&nbsp;</i>Зургийн цомог</li></a>
...
<div class="container">
   ...
   <div class="card2" style="height: 900px;border-radius: 20px;
            display: flex; position: none;
            box-shadow: 0 0 20px 6px #242524; position:none;
            justify-content: space-between;">                <div class="card2-body" >
                    <br>
                    <div class="titles">
                        <b> <h1 style="text-align: center"> Зургийн цомог</h1></b>
                         <br>
...
<link rel='stylesheet' href='{{url("/user/12album/unitegallery/css/unite-gallery.css")}}' type='text/css' />


    <script src="{{url("/imageShowTool/jquery.picEyes.js")}}"></script>

        <script src="{{url('/user/15bootstrap3.4.0/jquery-3.4.1-jquery.min.js')}}"></script>
        <script src="{{url('/user/15bootstrap3.4.0/bootstrap-3.4.0-bootstrap.min.js')}}"></script>

        <script src="{{url('user/12album/unitegallery/js/unitegallery.min.js')}}"></script>
        <script src="{{url('user/12album/unitegallery/js/unitegallery.js')}}"></script>



<script type='text/javascript' src='{{url("/user/12album/unitegallery/themes/tiles/ug-theme-tiles.js")}}'></script>
...
<script type="text/javascript">
  jQuery(document).ready(function(){
    jQuery("#galleryall").unitegallery({
