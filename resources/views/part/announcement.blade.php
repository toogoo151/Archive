...
<img class="wave" src="images/wave.png">
  ...
  <div class="topnav">
        ...
        <a href="{{url("/announcement")}}" style="color: white"> <li class="active"> <i class="fa fa-bell" aria-hidden="true" style="color: white">&nbsp;</i>Зарлал</li></a>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12" id="post-data">
            ...
            justify-content: space-between;">
            <br>
                <h2 class="text-center">ЗАРЛАЛ</h2>
