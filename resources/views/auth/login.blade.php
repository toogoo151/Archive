...
<div class="book {{ $errors->any() ? 'open' : '' }}" id="book">
    ...
    <div class="login-box">
              <h2>Нэвтрэх хэсэг</h2>
                            ...
                            <div class="input-box">
                                ...
                                <input type="hereglegch_ner" class="form-control @error('hereglegch_ner') is-invalid @enderror" name="hereglegch_ner"  required value="{{ old('hereglegch_ner') }}">
  ...
  <input type="password" id="nuuts_ug" 
         class="form-control @error('nuuts_ug') is-invalid @enderror" 
         name="nuuts_ug" required>
  <label>Нууц үг</label>
