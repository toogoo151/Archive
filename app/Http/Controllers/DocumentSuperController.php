...
class DocumentSuperController extends Controller
{
    ...
    public function getDocumentSuperTotal(Request $req) {
        try {
    ...
    public function getDocumentSuperChild(Request $req){
        try {
    ...
    public function documentSuperConfirm(Request $req){
        try {
    ...
    public function documentSuperDecline(Request $req){
        try {
