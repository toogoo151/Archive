...
return [
    ...
    'error-rename'      => 'Энэ нэртэй файл аль хэдийн үүссэн байна!',
    'error-file-name'   => 'File name cannot be empty!',
    'error-file-empty'  => 'You must choose a file!',
    'error-file-exist'  => 'Энэ нэртэй файл аль хэдийн үүссэн байна!',
    'error-file-size'   => 'Файлын хэмжээ хэтэрсэн байна! (Дээд хэмжээ: :max)',
    ...
    'error-size'        => 'Файлын хэмжээ хэтэрсэн байна!',
